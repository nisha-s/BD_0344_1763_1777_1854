...
mean_task_final.append(mean_task)
median_task_final.append(median_task)
...
#print(red1['end'])
#job_diff = abs(red1['time'] - df1['time'])
#job_diff = df1['job']
#print(job_diff)
...
mean_job_final.append(mean_job)
median_job_final.append(median_job)
